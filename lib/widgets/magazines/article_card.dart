  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Material(
        ...
        color: compressed ? Colors.black.withOpacity(0.2) : Colors.white,
        clipBehavior: Clip.antiAlias,
        borderRadius: BorderRadius.circular(20),
        child: BackdropFilter(
          filter: compressed ? ImageFilter.blur(sigmaX: 10, sigmaY: 10) : ImageFilter.blur(),
          child: Stack(
            children: [
              Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: parsePbTextStyle(theme.headingStyle).copyWith(
                            fontSize: 16,
                            color: compressed ? Colors.white : Theme.of(context).textTheme.headline4?.color,
                          ),
                          maxLines: compressed ? 2 : null,
